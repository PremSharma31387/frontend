...
export default function ProductDetails() {
  ...
  console.log("-------------->*", products.product?.category.name);
  console.log("token->>>>>>>>>>>>>", token);

  const handleAlert = () => {
    Swal.fire({
      title: "Login First",
      text: "Before Buying Product Please Login First",
      icon: "warning",
    });
  };
  ...
  const productData = [products.product?.category.name.toString()];
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  <Rating
                    ...
                    precision={0.5}
                  />
                  <p className="opacity-50 text-sm">45622 Rating</p>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60">54822 Ratings</p>
                </div>
